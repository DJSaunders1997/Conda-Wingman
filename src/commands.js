...
const { sendCommandToTerminal, activeFileIsYAML, getOpenDocumentPath, activateEnvFromYAML, createYAMLInputBox } = require('./utils');
const {createEnvIcon, activateEnvIcon, writeEnvIcon} = require("./statusBarItems"); // TODO: Make these arguments to the functions
